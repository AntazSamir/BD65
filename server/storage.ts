...
export class MemStorage implements IStorage {
  ...
  async createDestination(insertDestination: InsertDestination): Promise<Destination> {
    ...
    const destination: Destination = { 
      ...insertDestination, 
      id,
      history: insertDestination.history || ''
    };
  ...
  private async initializeSampleData() {
    ...
    await this.createDestination({
      ...
      history: 'Built in the 17th century during 1678-1684, Lalbagh Fort was constructed by Prince Muhammad Azam, son of Emperor Aurangzeb. The fort complex includes the tomb of Bibi Pari (Azam\'s daughter), a mosque, and the Diwan-i-Aam. Though never fully completed due to the untimely death of Bibi Pari, it stands as one of the finest examples of Mughal architecture in Bangladesh. The fort served as a residence for Mughal governors and has witnessed centuries of Bengali history, from Mughal rule through British colonization to Bangladesh\'s independence.',
    ...
    await this.createDestination({
      ...
      history: 'Named after Captain Hiram Cox, a British East India Company officer who worked to establish peace between local Arakanese refugees and Bengalis in 1799. Originally called \'Palongkee\', the area became a refuge for Arakanese people fleeing Myanmar. The 120-kilometer unbroken beach was formed over thousands of years by the Bay of Bengal\'s currents. During British rule, it developed as a fishing port and hill station. Today, it stands as the world\'s longest natural sea beach, attracting millions of visitors while maintaining its rich cultural heritage of Buddhist and Muslim communities.',
    ...
    await this.createDestination({
      ...
      history: 'The Sundarbans, meaning \'beautiful forest\' in Bengali, formed over 10,000 years ago through delta formation by the Ganges, Brahmaputra, and Meghna rivers. This UNESCO World Heritage Site has been home to the Munda and Malo communities for centuries, who traditionally collected honey and fish. British colonial records from the 1700s mention the forest as a source of timber and a haven for tigers. The Royal Bengal Tiger population here adapted uniquely to this saline environment. Declared a wildlife sanctuary in 1977, it now protects 400 tigers and countless other species while preserving traditional lifestyles of local communities.',
    ...
    await this.createDestination({
      ...
      history: 'Tea cultivation in Sylhet began in 1857 when British planters established the first tea garden at Malnichara, inspired by successful plantations in Assam. The industry flourished under British rule, with over 150 tea estates established by the early 1900s. The unique terroir of Sylhet\'s hills, combined with abundant rainfall and mist, creates ideal conditions for tea production. Many gardens were managed by British planters who built colonial bungalows and developed railway lines for transportation. After 1947, local entrepreneurs took over many estates, maintaining traditional processing methods while adapting to modern techniques.',
    ...
    await this.createDestination({
      ...
      history: 'Known locally as \'Narikel Jinjira\' (Coconut Island), Saint Martin was named by Portuguese sailors after Saint Martin of Tours. The island formed over millennia through coral deposits and sediment accumulation. First settled by Arabian traders around 1400 AD, it later became home to Bengali fishermen in the 18th century. During British rule, it served as a navigation point for ships traveling between Chittagong and Rangoon. The island\'s unique ecosystem supports Bangladesh\'s only coral reef, while local communities have traditionally subsisted on fishing and coconut cultivation, maintaining sustainable practices for generations.',
    ...
    await this.createDestination({
      ...
      history: 'Home to 11 indigenous tribal groups including Chakma, Marma, and Tripura peoples who have lived here for over 1,000 years. The region remained largely autonomous under Bengali Sultans and Mughal rulers who recognized tribal sovereignty. British colonial administration in 1860 established the Chittagong Hill Tracts as an \'excluded area\' with special autonomous status. The traditional \'jhum\' (shifting cultivation) agriculture and Buddhist-influenced cultures have been preserved for centuries. The 1997 Peace Accord recognized indigenous rights and established regional autonomy, making it a unique cultural region within Bangladesh where traditional governance systems continue alongside modern administration.',
    ...
    await this.createDestination({
      ...
      history: 'Rangamati, meaning \'Golden City\', was transformed in 1962 when the Kaptai Dam was built, creating Bangladesh\'s largest man-made lake. The dam displaced over 100,000 indigenous people, primarily Chakma communities, who had lived along the Karnaphuli River valleys for centuries. Before the dam, the area was known for its terraced hillside cultivation and traditional village life. The creation of Kaptai Lake submerged ancient settlements, temples, and agricultural lands, leading to significant cultural displacement. Today, the lake and surrounding areas showcase a unique blend of indigenous culture, scenic beauty, and modern development, with hanging bridges connecting hilltop communities.',
    ...
    await this.createDestination({
      ...
      history: 'Legend tells that Prince Vijoy Singha and his followers first landed at Kuakata in the 18th century while fleeing from Arakan (Myanmar). The name \'Kuakata\' comes from \'Kua\' (well) because early settlers had to dig wells for fresh water. The Rakhain (Arakanese) community established permanent settlements here, bringing their unique Buddhist culture and traditional fishing methods. For centuries, Kuakata remained a secluded fishing village until the 1980s when its unique geographical position - allowing both sunrise and sunset views from the same beach - was discovered by mainstream tourists. The indigenous Rakhain community continues to maintain their traditional lifestyle alongside modern tourism development.',
    ...
    await this.createDestination({
      ...
      history: 'Built in the 8th century during the Pala Empire, Paharpur Buddhist Vihara (Somapura Mahavihara) was once the largest Buddhist monastery south of the Himalayas. Founded by Emperor Dharmapala, it served as a major center of learning and Buddhist philosophy for over 400 years. The monastery housed over 1,000 monks and scholars who studied religion, philosophy, and sciences. Chinese traveler Hiuen Tsang\'s accounts describe it as a magnificent center of Buddhist education. After the decline of Buddhism in the region during the 12th century, the site was abandoned and gradually covered by vegetation until its rediscovery in 1919. UNESCO designated it a World Heritage Site in 1985, recognizing its architectural significance and historical importance.',
    ...
    await this.createDestination({
      ...
      history: 'Founded in the 15th century by the Turkish general and Sufi saint Ulugh Khan Jahan Ali, who came to Bengal to spread Islam. He established the city in 1459, building over 360 mosques, palaces, and other structures. The famous Sixty Dome Mosque (Shat Gombuj Masjid) represents the pinnacle of pre-Mughal Islamic architecture in Bengal. Khan Jahan Ali transformed the malaria-infested swampland into a thriving city through innovative urban planning, including a sophisticated water management system. After his death in 1459, the city remained an important center of Islamic learning and culture. UNESCO recognized the Historic Mosque City of Bagerhat as a World Heritage Site in 1985 for its exceptional architectural heritage.',
    ...
    await this.createDestination({
      ...
      history: 'Inhabited by the Lusai indigenous community for over 500 years, Sajek Valley remained largely unknown to mainstream Bangladesh until the 1980s. The name \'Sajek\' derives from the Lusai word meaning \'bird\' due to the valley\'s position among cloud-touching peaks where birds migrate. Traditional Lusai communities practiced shifting cultivation and maintained their animistic beliefs alongside Buddhist influences. The valley\'s isolation preserved unique tribal customs, handicrafts, and architectural styles. Tourism development began in the 2000s, bringing economic opportunities while challenging the balance between preserving indigenous culture and modernization. Today, Sajek serves as a window into Bangladesh\'s hill tribe heritage while offering spectacular mountain scenery.',
    ...
    await this.createDestination({
      ...
      history: 'Located along the Dawki River on the Bangladesh-India border, Jaflong has been a natural stone collection site for over 200 years. Local communities, primarily the Khasi and Manipuri peoples, have traditionally collected stones carried down from the Meghalaya hills by river currents. British colonial records from the 1800s mention the area as a strategic border point and natural resource site. The unique geological formation creates a natural stone crushing process as river waters carry stones from the Shillong plateau. Traditional stone collection methods passed down through generations involve families working together during dry seasons to extract stones for construction purposes, creating a sustainable livelihood that respects the natural ecosystem.',
    ...
    await this.createDestination({
      ...
      history: 'Established as Bangladesh\'s tea capital in the early 1900s when British colonial administrators identified the region\'s ideal climate for tea cultivation. The town grew around the Srimangal Tea Research Institute, founded in 1957, which became the center of tea innovation in South Asia. Local communities, including the indigenous Tipra and Manipuri peoples, initially worked as tea garden laborers before many became tea entrepreneurs. The famous seven-layer tea tradition began in the 1980s when local tea vendors discovered how to layer teas of different densities and colors. Srimangal is also home to the Lawachara National Park, preserving the last remaining tropical rainforest in the region, where endangered species like the hoolock gibbons have been protected for decades.',
    ...
    await this.createDestination({
      ...
      history: 'Named after the famous Indian hill station, Nilgiri in Bandarban represents the development of hill tourism in Bangladesh during the 1990s. The area was traditionally inhabited by Marma and Bom indigenous communities who practiced terrace farming and maintained Buddhist monasteries on the hilltops. The highest accessible peak in Bangladesh at 2,320 feet, Nilgiri was developed as a tourist destination by the Bangladesh Army to promote eco-tourism while providing economic opportunities to local tribal communities. The construction of the Nilgiri Resort in the early 2000s marked the beginning of organized tourism in the Chittagong Hill Tracts, carefully balancing modern amenities with respect for indigenous culture and environmental conservation.',
    ...
    await this.createDestination({
      ...
      history: 'Nafakhum, meaning \'water that never stops\' in the local Marma language, was revered by indigenous communities as a sacred site for centuries. The waterfall remained largely unknown to mainstream Bangladesh until the 1980s when adventurous trekkers began exploring the remote Thanchi region. Local Marma and Bom communities traditionally believed the waterfall possessed healing powers and conducted spiritual ceremonies near its base. The challenging journey to reach Nafakhum - involving river crossings and hill trekking - has been preserved as part of the adventure experience. Conservation efforts began in the 2000s to protect the surrounding ecosystem, including rare orchids and wildlife, while allowing controlled eco-tourism that benefits local communities.',
    ...
    await this.createDestination({
      ...
      history: 'Dating back to the 3rd century BCE, Mahasthangarh is Bangladesh\'s oldest archaeological site and the ancient city of Pundranagar, capital of the Mauryan province of Pundravardhana. The fortified city flourished for over 1,500 years under various dynasties including Mauryan, Gupta, and Pala empires. Archaeological excavations since 1928 have uncovered palaces, temples, residential areas, and sophisticated urban planning systems including drainage and road networks. The site served as a major Buddhist center during the Pala period, with numerous monasteries and stupas. Chinese traveler Hiuen Tsang visited the city in 639 CE, describing its prosperity and Buddhist monuments. The nearby shrine of Shah Sultan Balkhi, a 14th-century Sufi saint, adds Islamic heritage to this multi-layered historical site.',
    ...
    await this.createDestination({
      ...
      history: 'Ratargul is Bangladesh\'s only freshwater swamp forest, formed naturally over thousands of years through seasonal flooding of the Goain River. Local communities have known about this unique ecosystem for generations, using traditional boats to navigate during monsoon months when the forest floor becomes submerged up to 20 feet. The forest gained national attention in the 1990s when environmentalists recognized its ecological importance as habitat for over 73 tree species and numerous birds, including migratory species. The name \'Ratargul\' comes from the twisted shape of the trees, which appear like intertwined stories when reflected in the water. Conservation efforts began in 2015 to protect this rare ecosystem while developing sustainable eco-tourism that employs local boatmen and guides.',
