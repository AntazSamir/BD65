    ...
    <section className="py-16 bg-gradient-to-r from-primary to-secondary text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Why Choose TravelHub?</h2>
          <p className="text-xl opacity-90">Your trusted partner for unforgettable travel experiences</p>
        </div>
